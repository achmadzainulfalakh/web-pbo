 <nav class="navbar navbar-inverse navbar-fixed-top">
 	<div class="container-fluid">
 		...
 		<ul class="nav navbar-nav">
 			...
 			<li><a href="http://localhost/web-pbo/Materi7-RoleAccess/index.php/users/users">Users</a></li>
 			<?php 
 			...
 			<li><a href="http://localhost/web-pbo/Materi7-RoleAccess/index.php/users/profile">Profile</a></li>
 			<li><a href="http://localhost/web-pbo/Materi7-RoleAccess/index.php/users/logout">Logout</a></li>
 		</ul>
 	</div>
 </nav> 